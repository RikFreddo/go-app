const decks = {
    ...
    "fondamentali_ja": {
        ...
        cards: [
            ...
            { id: "base_grande_ja", lang: "ja", level: 1, word: "大", pronunciation: "だい", meaning: "Grande", type: "base", pos: "adj" },
            { id: "base_piccolo_ja", lang: "ja", level: 1, word: "小", pronunciation: "しょう", meaning: "Piccolo", type: "base", pos: "adj" }
        ]
    },
    ...
    "natura_zh": {
        ...
        cards: [
            ...
            { id: "zh19", lang: "zh", level: 2, word: "花", pronunciation: "huā", meaning: "Fiore", type: "derivato", requires: ["rad_albero"], pos: "noun" },
            ...
            { id: "zh35", lang: "zh", level: 3, word: "夏", pronunciation: "xià", meaning: "Estate", type: "base", requires: ["rad_sole"], pos: "noun" },
    ...
    "natura_ja": {
        ...
        cards: [
            ...
            { id: "ja36", lang: "ja", level: 3, word: "夏", pronunciation: "なつ", meaning: "Estate", type: "base", requires: ["rad_sole_ja"], pos: "noun" },
            { id: "ja37", lang: "ja", level: 3, word: "秋", pronunciation: "あき", meaning: "Autunno", type: "base", requires: ["rad_albero_ja"], pos: "noun" },
            { id: "ja38", lang: "ja", level: 3, word: "冬", pronunciation: "ふゆ", meaning: "Inverno", type: "base", requires: ["rad_pioggia_ja"], pos: "noun" }
        ]
    },
    "natura_ar": {
    ...
    "viaggio_zh": {
        ...
        cards: [
            ...
            { id: "v_zh4", lang: "zh", level: 1, word: "机", pronunciation: "jī", meaning: "Macchina", type: "base", requires: ["rad_albero"], pos: "noun" },
            { id: "v_zh5", lang: "zh", level: 2, word: "飞机", pronunciation: "fēijī", meaning: "Aereo", type: "base", pos: "noun" },
            { id: "v_zh6", lang: "zh", level: 2, word: "火车", pronunciation: "huǒchē", meaning: "Treno", type: "derivato", requires: ["rad_fuoco", "rad_veicolo"], pos: "noun" },
            { id: "v_zh7", lang: "zh", level: 2, word: "车站", pronunciation: "chēzhàn", meaning: "Stazione", type: "derivato", requires: ["rad_veicolo"], pos: "place" },
            { id: "v_zh16", lang: "zh", level: 3, word: "门口", pronunciation: "ménkǒu", meaning: "Ingresso", type: "derivato", requires: ["rad_porta", "rad_bocca"], pos: "place" }
        ]
    },
    "viaggio_ja": {
    ...
    "grammatica_zh": {
        ...
        cards: [
            ...
            { id: "g_zh2", lang: "zh", level: 2, word: "你", pronunciation: "nǐ", meaning: "Tu", type: "derivato", requires: ["rad_uomo"], pos: "pronoun" },
            { id: "g_zh6", lang: "zh", level: 1, word: "吃", pronunciation: "chī", meaning: "Mangiare", type: "derivato", requires: ["rad_bocca"], pos: "verb_eat" }
        ]
    },
    "grammatica_ar": {
        ...
        cards: [
            ...
            { id: "g_ar7", lang: "ar", level: 1, word: "يَأْكُلُ", pronunciation: "ya'kulu", meaning: "Mangia", type: "derivato", requires: ["root_akl"], pos: "verb_eat" }
        ]
    },
    "grammatica_ja": {
